...
goog.exportSymbol('proto.jasper.vault.v1.MsgSignOptionPrice', null, global);
goog.exportSymbol('proto.jasper.vault.v1.MsgSignOptionPriceResponse', null, global);
/**
 ...
 * @constructor
 */
proto.jasper.vault.v1.MsgSignOptionPrice = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.jasper.vault.v1.MsgSignOptionPrice, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.jasper.vault.v1.MsgSignOptionPrice.displayName = 'proto.jasper.vault.v1.MsgSignOptionPrice';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.jasper.vault.v1.MsgSignOptionPriceResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.jasper.vault.v1.MsgSignOptionPriceResponse.displayName = 'proto.jasper.vault.v1.MsgSignOptionPriceResponse';
}
 ...
 * @return {!Object}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.toObject = function(opt_includeInstance) {
  return proto.jasper.vault.v1.MsgSignOptionPrice.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.jasper.vault.v1.MsgSignOptionPrice} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.jasper.vault.v1.MsgSignOptionPrice.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.jasper.vault.v1.MsgSignOptionPrice}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.jasper.vault.v1.MsgSignOptionPrice;
  return proto.jasper.vault.v1.MsgSignOptionPrice.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.jasper.vault.v1.MsgSignOptionPrice} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.jasper.vault.v1.MsgSignOptionPrice}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.jasper.vault.v1.MsgSignOptionPrice.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.jasper.vault.v1.MsgSignOptionPrice} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.jasper.vault.v1.MsgSignOptionPrice.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.getOptionasset = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.jasper.vault.v1.MsgSignOptionPrice} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.setOptionasset = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.getPayload = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.jasper.vault.v1.MsgSignOptionPrice} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.setPayload = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.getSender = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.jasper.vault.v1.MsgSignOptionPrice} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPrice.prototype.setSender = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.jasper.vault.v1.MsgSignOptionPriceResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    optionasset: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.jasper.vault.v1.MsgSignOptionPriceResponse}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.jasper.vault.v1.MsgSignOptionPriceResponse;
  return proto.jasper.vault.v1.MsgSignOptionPriceResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.jasper.vault.v1.MsgSignOptionPriceResponse}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.jasper.vault.v1.MsgSignOptionPriceResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOptionasset();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.getOptionasset = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.setOptionasset = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.getCount = function() {
 ...
 * @return {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.setCount = function(value) {
 ...
 * @return {number}
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.getTimestamp = function() {
 ...
 * @return {!proto.jasper.vault.v1.MsgSignOptionPriceResponse} returns this
 */
proto.jasper.vault.v1.MsgSignOptionPriceResponse.prototype.setTimestamp = function(value) {
